...
when_to_use: Making sense of a pile of interview notes, survey responses, or support tickets; extracting themes and ranking findings by frequency and impact; turning raw user feedback into roadmap recommendations; producing a structured research synthesis with prioritized opportunity areas.
...
Apply thematic analysis. The full methodology - thematic analysis steps,
affinity mapping, triangulation, interview note analysis, survey data
interpretation, qual/quant integration, persona development, and opportunity
sizing - lives in
[references/research-methodology.md](references/research-methodology.md). Read
it before coding themes or building personas.

Group observations into themes, count frequency across participants, and
assess impact severity. Note contradictions and surprises.
