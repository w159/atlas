...
when_to_use: Turning a vague idea or user request into a structured PRD; scoping a feature with explicit goals and non-goals; defining success metrics and acceptance criteria for a feature; breaking a large ask into a phased spec.
...
Produce a structured PRD with these sections. The full template, user-story
guidance, requirements categorization (MoSCoW), success metrics, acceptance
criteria format, and scope-management patterns live in
[references/spec-template.md](references/spec-template.md). Read it before
drafting.
