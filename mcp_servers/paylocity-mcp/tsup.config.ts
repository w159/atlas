...
/**
 * esbuild plugin that resolves ../../../_shared/*.js imports in src/domains/
 * to the .ts source files in mcp_servers/_shared/. tsup v8 has no top-level
 * alias option, so we wire this manually via esbuildPlugins.
 *
