...
While the orchestrate skill is active, the orchestrator has STANDING CONSENT to fan out to subagents for every substantive task without re-asking. Optimize for the most exhaustive correct answer, not the fastest one. Work solo only on trivial or purely conversational turns where a subagent would add nothing.
