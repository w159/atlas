...
Orientation for this directory. `.atlas/` is atlas's own runtime and
operational state (execution evidence, findings, audits, decisions,
memory), never product source and never a project wiki. Project
documentation lives under `docs/` at the repo root, not here.
