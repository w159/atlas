...
2. **Retrieve training campaigns**
   - Use `knowbe4_training_campaigns_list` to find active campaigns
   - Use `knowbe4_training_campaigns_get` for specific campaign details

3. **Get enrollment data**
   - Use `knowbe4_training_enrollments_list` for campaign enrollments
