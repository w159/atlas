...
5. **Capture** screenshots + console + network into `.atlas/docs/evidence/`. Tear down the server.
...
5. Use `whodb`/data-agent-kit plugins or `gcloud` if present and helpful. Capture plans into `.atlas/docs/evidence/`.
