# Microsoft Graph API references - mailboxes
...
1. Outlook mail API overview (inbox rules, shared mailboxes, mail flow) - https://learn.microsoft.com/graph/outlook-mail-concept-overview
2. Use the Microsoft Search API to search Outlook messages - https://learn.microsoft.com/graph/search-concept-messages
3. message: forward (v1.0) - https://learn.microsoft.com/graph/api/message-forward?view=graph-rest-1.0
4. Microsoft Graph permissions reference (Mail.Read, Mail.ReadWrite, Mail.Send) - https://learn.microsoft.com/graph/permissions-reference
