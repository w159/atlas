...
Route this to `orc-verifier`. Its `rejected` verdict sends the item back to a fresh implementer with the failure attached.

## Completeness critic

A final pass - `orc-completeness-critic` - that asks one question: **what is missing?**
