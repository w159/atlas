# Microsoft Graph API references - cipp-tenants
...
1. CIPP documentation (tenant list, tenant details) - https://docs.cipp.dev
2. Microsoft Graph organization resource type (tenant profile) - https://learn.microsoft.com/graph/api/resources/organization?view=graph-rest-1.0
3. Microsoft Graph MCP Server for Enterprise overview - https://learn.microsoft.com/graph/mcp-server/overview
