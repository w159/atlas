# Roadmap Format and Frameworks Reference

Reference for the roadmap-update skill. Holds the roadmap format options,
prioritization frameworks, dependency mapping, capacity planning, and
roadmap-change communication guidance. The skill body points here when the
user needs the framework detail rather than the workflow.
