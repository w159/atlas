...
Detailed component catalog, data-binding patterns, styling, and performance
notes for the interactive-dashboard-builder skill. One level deep: read the
section you need, no further references required.

## Chart.js Integration

### Shared Color Constant
