# Stakeholder Update Templates and Frameworks Reference

Reference for the stakeholder-update skill. Holds the per-audience update
templates, status reporting framework (G/Y/R), risk communication, decision
documentation (ADRs), and meeting facilitation guidance. The skill body points
here when the user needs the template detail rather than the workflow.
