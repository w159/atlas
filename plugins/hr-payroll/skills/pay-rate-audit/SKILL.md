---
name: pay-rate-audit
description: Audit pay rates across the active Paylocity roster -- flags missing/zero rates, future-dated changes, and outliers vs. pay grade. Use when user asks for "pay rate audit", "comp review", "salary check", or before a merit-cycle / payroll run.
---
