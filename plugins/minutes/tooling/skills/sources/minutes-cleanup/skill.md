...
triggers:
  - clean up recordings
  - how much space are meetings using
  - delete old recordings
  - archive meetings
  - manage meeting storage
user_invocable: true
metadata:
...
output:
  claude:
    path: .claude/plugins/minutes/skills/minutes-cleanup/SKILL.md
  codex:
    path: .agents/skills/minutes/minutes-cleanup/SKILL.md
tests:
  golden: true
  lint_commands: true
---
