# Metrics Hierarchy and Review Frameworks Reference

Reference for the metrics-review skill. Holds the product metrics hierarchy
(North Star, L1, L2), common metric definitions, goal-setting frameworks,
review cadences, and dashboard design principles. The skill body points here
when the user needs the framework detail rather than the workflow.
