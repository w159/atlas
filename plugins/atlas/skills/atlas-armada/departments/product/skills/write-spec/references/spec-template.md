# Spec Template and PRD Reference

Reference for the write-spec skill. Holds the full PRD structure, user story
writing guidance, requirements categorization, success metrics, acceptance
criteria, and scope management. The skill body points here when the user needs
the template detail rather than the workflow.
