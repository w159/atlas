# Research Synthesis Methodology Reference

Reference for the synthesize-research skill. Holds thematic analysis,
...
sizing guidance. The skill body points here when the user needs the
methodology detail rather than the workflow.
