# Competitive Analysis Frameworks Reference

Reference for the competitive-brief skill. Holds the landscape mapping,
feature comparison matrices, positioning analysis frameworks, win/loss
methodology, and market trend identification guidance. The skill body points
here when the user needs framework detail rather than the workflow.
