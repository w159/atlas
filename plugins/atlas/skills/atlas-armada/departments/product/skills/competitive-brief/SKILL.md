...
when_to_use: Building a competitive analysis brief for one or more competitors; informing product strategy or feature prioritization decisions; creating sales battle cards or board/investor materials; deciding where to differentiate versus achieve parity.
...
#### Feature Comparison
Compare capabilities across key areas relevant to the analysis. Use the
rating scales and matrix template in
[references/competitive-frameworks.md](references/competitive-frameworks.md).

#### Positioning Analysis
Analyze how each competitor positions themselves - target customer, category
claim, key differentiator, and value proposition. The positioning statement
template and message architecture levels live in
[references/competitive-frameworks.md](references/competitive-frameworks.md).
...
The landscape mapping (direct, indirect, adjacent, substitute), feature
comparison matrices and rating scales, positioning analysis frameworks,
win/loss analysis methodology, and market trend identification guidance live
in [references/competitive-frameworks.md](references/competitive-frameworks.md).
Read it when generating any section that needs the framework detail.
